...
import (
	...
	"github.com/go-flow/flow/v3/web/response"
)
...
func ResponseDownload(code int, name string, reader io.Reader) Response {
	return response.NewDownload(code, name, reader)
}
