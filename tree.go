...
func (n *node) addRoute(path string, handle *Route) {
	fullPath := path
	n.priority++
...
func (n *node) insertChild(path, fullPath string, handle *Route) {
	for {
...
// given path.
func (n *node) getValue(path string, params func() *Params) (handle *Route, ps *Params, tsr bool) {
