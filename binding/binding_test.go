...
func testBodyBinding(t *testing.T, b Binder, name, path, badPath, body, badBody string) {
...
func testBodyBindingUseNumber(t *testing.T, b Binder, name, path, badPath, body, badBody string) {
	assert.Equal(t, name, b.Name())
...
func testBodyBindingUseNumber2(t *testing.T, b Binder, name, path, badPath, body, badBody string) {
	assert.Equal(t, name, b.Name())
...
func testBodyBindingFail(t *testing.T, b Binder, name, path, badPath, body, badBody string) {
	assert.Equal(t, name, b.Name())
